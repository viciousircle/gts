...
if __name__ == "__main__":
    ...
    if not check:
        ...
        if choose == 1:
            fout = open("/Users/a8888/Documents/doc uni/gts/Numerical-Analysis-Code-main/F(x)_Equation/tieptuyen/output_tn.txt", mode='w', encoding='utf-8')
            x0 = tieptuyen(a, b, 1)
            ...
            fout = open("/Users/a8888/Documents/doc uni/gts/Numerical-Analysis-Code-main/F(x)_Equation/tieptuyen/output_hn.txt", mode='w', encoding='utf-8')
            x0 = tieptuyen(a, b, 2)
            print("Nghiệm của phương trình: ", x0[0])
            print("Số lần lặp: ", x0[1])
            fout.write(f"\nNghiệm của phương trình: {x0[0]}")
